...
public class SimpleRGBTester {
	public static void main(String[] args) {
		...
		if (rgb.getGreen(x, y) != green) {
			...
			System.out
					.println("But your method rgb.getGreen(" + x + "," + y + ") return " + rgb.getGreen(x, y) + ".\n");
		} else {
			point += 1;
			System.out.println("PASS");
		}
		...
		if (redImage.getRed(x, y) != red || redImage.getGreen(x, y) != 0 || redImage.getBlue(x, y) != 0) {
			System.out.println("FAIL");
			System.out
					.println("The variable redImage of type SimpleRGB was initialized using the following statement:");
			System.out.println("   SimpleRGB redImage = rgb.getRedImage();");
			System.out.println("The (R,G,B) values of the rgb image at (" + x + "," + y + ") are (" + red + "," + green
					+ "," + blue + ").");
			System.out.println(
					"The (R,G,B) values of the redImage at (" + x + "," + y + ") should be (" + red + ",0,0).");
		...
		if (greenImage.getRed(x, y) != 0 || greenImage.getGreen(x, y) != green || greenImage.getBlue(x, y) != 0) {
			System.out.println("FAIL");
			System.out.println(
					"The variable greenImage of type SimpleRGB was initialized using the following statement:");
			System.out.println("   SimpleRGB greenImage = rgb.getGreenImage();");
			System.out.println("The (R,G,B) values of the rgb image at (" + x + "," + y + ") are (" + red + "," + green
					+ "," + blue + ").");
			System.out.println(
					"The (R,G,B) values of the greenImage at (" + x + "," + y + ") should be (0," + green + ",0).");
			System.out.println("But your method");
			System.out.println("   greenImage.getRed(" + x + "," + y + ") returns " + greenImage.getRed(x, y) + ".");
			System.out
					.println("   greenImage.getGreen(" + x + "," + y + ") returns " + greenImage.getGreen(x, y) + ".");
		...
		if (blueImage.getRed(x, y) != 0 || blueImage.getGreen(x, y) != 0 || blueImage.getBlue(x, y) != blue) {
			System.out.println("FAIL");
			System.out
					.println("The variable blueImage of type SimpleRGB was initialized using the following statement:");
			System.out.println("   SimpleRGB blueImage = rgb.getBlueImage();");
			System.out.println("The (R,G,B) values of the rgb image at (" + x + "," + y + ") are (" + red + "," + green
					+ "," + blue + ").");
			System.out.println(
					"The (R,G,B) values of the blueImage at (" + x + "," + y + ") should be (0,0," + blue + ").");
			System.out.println("But your method");
		...
		if (greyImage.getRed(x, y) != greyValue || greyImage.getGreen(x, y) != greyValue
				|| greyImage.getBlue(x, y) != greyValue) {
			System.out.println("FAIL");
			System.out
					.println("The variable greyImage of type SimpleRGB was initialized using the following statement:");
			System.out.println("   SimpleRGB greyImage = rgb.getGreyImage();");
			System.out.println("The (R,G,B) values of the rgb image at (" + x + "," + y + ") is (" + red + "," + green
					+ "," + blue + ").");
			System.out.println("The (R,G,B) values of the greyImage at (" + x + "," + y + ") should be (" + greyValue
					+ "," + greyValue + "," + greyValue + ").");
			System.out.println("But your method");
